...
from pjecz_delphinus_flask.blueprints.distritos.forms import DistritoForm
...
def select_json():
    ...
    consulta = consulta.order_by(Distrito.nombre).all()
    resultados = [{"id": d.id, "text": f"{d.clave}: {d.nombre}"} for d in consulta]
