...
def datatable_json():
    """DataTable JSON para listado de UDP Visitas"""
        ...
        data.append(
            {
                "detalle": {
                    "id": resultado.id,
                    "url": url_for("udp_visitas.detail", udp_persona_visita_id=resultado.id),
                },
...
def list_active():
    """Listado de UDP Visitas activos"""
...
def list_inactive():
    """Listado de UDP Visitas inactivos"""
    return render_template(
        "udp_visitas/list.jinja2",
...
@udp_visitas.route("/udp_visitas/<int:udp_persona_visita_id>")
def detail(udp_persona_visita_id):
    """Detalle de un UDP Persona Visita"""
    udp_persona_visita = UdpVisita.query.get_or_404(udp_persona_visita_id)
    return render_template("udp_visitas/detail.jinja2", udp_persona_visita=udp_persona_visita)
...
@udp_visitas.route("/udp_visitas/edicion/<int:udp_persona_visita_id>", methods=["GET", "POST"])
...
def edit(udp_persona_visita_id):
    ...
    return render_template("udp_visitas/edit.jinja2", form=form, udp_persona_visita=udp_persona_visita)


@udp_visitas.route("/udp_visitas/eliminar/<int:udp_persona_visita_id>")
@permission_required(MODULO, Permiso.ADMINISTRAR)
...
@udp_visitas.route("/udp_visitas/recuperar/<int:udp_persona_visita_id>")
@permission_required(MODULO, Permiso.ADMINISTRAR)
