...
from pjecz_delphinus_flask.lib.safe_string import (
    CONTRASENA_REGEXP,
    EMAIL_REGEXP,
    safe_email,
    safe_message,
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if identidad is None or contrasena is None:
            flash("Debe de proporcionar usuario y contraseña.", "warning")
        elif re.fullmatch(EMAIL_REGEXP, identidad) is None:
